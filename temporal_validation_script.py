...
print("Temporal validation script", end="\n\n")
...
validation_fold_df = (
    validation_fold_df[validation_fold_df["sender"].isin(unique_train_senders)]
)
...
print("\nTemporal validation score :", validation_fold_score)

print("\nTemporal validation script completed in %0.2f seconds"
      % (time() - initial_time))
