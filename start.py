...
if not os.path.isdir("data"):
    print(
        "You first have to create the data directory and put the input "
        "files in it"
    )
...
for file_name in input_filenames:
    if not os.path.exists("data/" + file_name):
        print(
            "You first have to put the file {file_name} in the data directory"
            .format(file_name=file_name)
        )

# Run the preprocessing script
os.system("python3 csv_preprocessing_script.py")
